...
namespace NewsAgregator.Controllers
{
    public class HomeController : Controller
    {
        ...
        /// <summary>
        /// Главная страница, стартовый метод.
        /// </summary>
        ...
        /// <summary>
        /// Производит поиск среди всех новостей по заголовку или тексту новости.
        /// </summary>
        /// <param name="id">Номер страницы.</param>
        ...
        /// <summary>
        /// Выбирает отображаемые источники.
        /// </summary>
        /// <param name="RC">Роскосмос</param>
        /// <param name="AW">Авиация России</param>
        /// <param name="FAVT">ФАВТ</param>
        /// <param name="FG">FlightGlobal</param>
        /// <returns></returns>
        [HttpPost]
        public IActionResult ChooseSource(bool? RC, bool? AW, bool? FAVT, bool? FG)
        {
            dbNews = Context.News.OrderByDescending(s => s.Date).ToList(); // сортируем новости по дате
            ...
            if (AW == true)
            {
                newList.AddRange(dbNews.Where(n => n.NewsURL.Contains("aviation21.ru")));
            }
            if (FAVT == true)
            {
                newList.AddRange(dbNews.Where(n => n.NewsURL.Contains("favt.ru")));
            }
            if (FG == true)
            {
